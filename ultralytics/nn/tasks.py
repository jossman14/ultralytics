...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        elif m in {v10Detect, LEDHead}:
            # LEDHead's __init__(nc, ch) predates the reg_max/end2end Detect signature; keep it on the
            # simple (nc, ch) call path alongside v10Detect rather than the frozenset above.
